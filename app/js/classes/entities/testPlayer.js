...
export default class Player extends Entity {
    constructor({ xPosition, yPosition, width, height, xSpeed, ySpeed, speed, health, attackDamage, canvas }) {
        super({ xPosition, yPosition, width, height, xSpeed, ySpeed, speed, health, attackDamage, canvas })
    ...
    get isAttackDepressed() { return this.attackKeyDepressed }
    set isAttackDepressed(bool) { this.attackKeyDepressed = bool }
    ...
    update(keys, deltaTime) {
        ...
        //     if (keys["k"] && !this.isAttackDepressed) {
        //         this.startAttack()
        //     }
        // }
        // if (!keys["k"] && this.isAttackDepressed) {
        //     this.isAttackDepressed = false;
        // }
        // END

        // if (checkCanvasCollision(this.bounds, this.canvas)) {
        //     this.position = {
        //         x: Math.max(0, Math.min(this.position.x, this.canvas.width - this.dimensions.width)),
        //         y: Math.max(0, Math.min(this.position.y, this.canvas.height - this.dimensions.height))
        //     }
        // }
    ...
    draw() {
        this.canvas.ctx.fillStyle = 'blue'; // Draw the player on the canvas
